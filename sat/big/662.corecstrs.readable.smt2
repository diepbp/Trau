...
(assert (ite T_SELECT_1 (and (= PCTEMP_LHS_1 (+ I0_3 0)) (= var_0xINPUT_6552 (Concat T0_3 T1_3)) (= I0_3 (Length T4_3)) (= 0 (Length T0_3)) (= T1_3 (Concat T2_3 T3_3)) (= T2_3 (Concat T4_3 T5_3)) (= T5_3 "?") (not (= T4_3 "?"))) (and (= PCTEMP_LHS_1 (- 1)) (= var_0xINPUT_6552 (Concat T0_3 T1_3)) (= 0 (Length T0_3)) (not (= T1_3 "?")))))
(assert (= T_3 (= PCTEMP_LHS_1 (- 1))))
(assert (= T_4 (not T_3)))
(assert T_4)
(assert (= T_SELECT_2 (not (= PCTEMP_LHS_2 (- 1)))))
(assert (ite T_SELECT_2 (and (= PCTEMP_LHS_2 (+ I0_7 0)) (= var_0xINPUT_6552 (Concat T0_7 T1_7)) (= I0_7 (Length T4_7)) (= 0 (Length T0_7)) (= T1_7 (Concat T2_7 T3_7)) (= T2_7 (Concat T4_7 T5_7)) (= T5_7 "#") (not (= T4_7 "#"))) (and (= PCTEMP_LHS_2 (- 1)) (= var_0xINPUT_6552 (Concat T0_7 T1_7)) (= 0 (Length T0_7)) (not (= T1_7 "#")))))
...
(assert (= var_0xINPUT_6552 (Concat T1_11 T2_11)))
(assert (= T2_11 (Concat PCTEMP_LHS_3 T3_11)))
(assert (= T_7 (Length T1_11)))
(assert (= I1_11 (Length var_0xINPUT_6552)))
