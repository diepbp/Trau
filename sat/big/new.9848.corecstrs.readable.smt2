...
(assert (ite T_SELECT_3 (and (= PCTEMP_LHS_5 (+ I0_19 0)) (= T_c (Concat T0_19 T1_19)) (= I0_19 (Length T4_19)) (= 0 (Length T0_19)) (= T1_19 (Concat T2_19 T3_19)) (= T2_19 (Concat T4_19 T5_19)) (= T5_19 "=") (not (= T4_19 "="))) (and (= PCTEMP_LHS_5 (- 1)) (= T_c (Concat T0_19 T1_19)) (= 0 (Length T0_19)) (not (= T1_19 "=")))))
